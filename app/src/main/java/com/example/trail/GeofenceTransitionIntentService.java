...
/**
 * Created by Anjali on 09-11-2015.
 */
    ...
    public class GeofenceTransitionsIntentService extends IntentService {
        ...
        protected void onHandleIntent(Intent intent) {
            ...
            if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
                ...
                // Geofences that were triggered. A single event can trigger multiple geofences.
        ...
        private String getGeofenceTransitionDetails(
            ...
            // the string of the information of the geofence.
            String geofenceTransitionString = getTransitionString(geofenceTransition);

            // Get the Ids of each geofence that was triggered.
            ArrayList triggeringGeofencesIdsList = new ArrayList();
            //for geofence in all the triggering geofences list add its id to the triggeringGeofencesIdsList
